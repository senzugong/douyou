...
return [
    ...
    'app_namespace'          => 'app',
    //图片路径
    'image_url'          => 'http://douwan.vm.com/',
    //七牛路径
    'qn_url'          => 'http://qiniu.rmq168.com/',
    //七牛路径
   //  'qn_url'          => 'http://pihjjeyfh.bkt.clouddn.com/',
    // 对接交流中心的地址
    'remote_host'          => 'http://test.api.rmq168.com/',
    // 交流中心2.0转账
    'fmaster_host'          => 'http://fmaster.rmq168.com/',
    // 应用调试模式
    'app_debug'              => true,
    // 应用Trace
    'app_trace'              => false,
...
//    'exception_tmpl'         => APP_PATH . 'extra' . DS . 'view' . DS . 'handler.exception.html',
    ...
    'SMS_CONFIG'               => [
        "sign"              =>      '蚪游', //审核通过的签名
        "key"               =>      'LTAIqokQDBwMP1b7', //阿里云生成的 accessKeyId
        "secret"            =>      '5GvIsXbTShy0sA1AjnzApTWzaMT2Zk', // 阿里云生成的 accessKeySecret
    ],
    'smscode'          =>  'SMS_161350033',

    // 短信测试，验证码取手机号后6位
    'SMS_DEBUG'=>true,
    // 极光推送的配置
    'jiguang'=> [
        'AppKey'=> 'b151de760bd8eabdd4c9f794',
        'MasterSecret'=> 'fd3c8c99cf5767f5157f7f98',
    ],
    // +----------------------------------------------------------------------
